...
with cadastro:
    ...
    with col2:
        st.image(
            image="https://archives.bulbagarden.net/media/upload/thumb/6/6a/Lechonk.png/250px-Lechonk.png",
            caption="Lechonk"
        )

    with col3:
        st.image(
            image="https://upload.wikimedia.org/wikipedia/en/thumb/d/dc/Thomas_Tank_Engine_1.JPG/220px-Thomas_Tank_Engine_1.JPG",
